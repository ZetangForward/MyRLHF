...
from ms_poe_self_extend import flash_self_extend_forward, self_extend_forward
import selfextend_flash_attn
    ...
    if 'Llama' in arch_name:
        if enable_flash_attention:
            if flash_attention_impl == "flash_attention_2":
                ...
                modifed_1 = modify_method_of_instance(loaded_model, "LlamaFlashAttention2", "_flash_attention_forward", selfextend_flash_attn.flash_attention2_forward_with_window_size)
            ...
            self_extend_attention_forward = partial(self_extend_forward,
                                            group_size_1=group_size, 
                                            group_size_2=window_size,
                                            scale_base=scale_base)
        ...
        raise NotImplementedError(f"Unsupported architecture: {arch_name}")
