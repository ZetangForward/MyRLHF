...
#SBATCH --job-name=3900_reasoning_head_detection  # 任务名称
...
#SBATCH --output=/mnt/petrelfs/tangzecheng/MyRLHF/reetrievalheaddetect/logs/3900.log  # 标准输出日志
#SBATCH --error=/mnt/petrelfs/tangzecheng/MyRLHF/reetrievalheaddetect/logs/3900.err   # 错误日志
#SBATCH --partition=s2_bigdata                # 指定分区
...
python reasoning_head_detection_babilong.py --context_lengths=3900