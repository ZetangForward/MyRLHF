...
#SBATCH --job-name=1900_reasoning_head_detection  # 任务名称
...
#SBATCH --output=/mnt/petrelfs/tangzecheng/MyRLHF/reetrievalheaddetect/logs/1900.log  # 标准输出日志
#SBATCH --error=/mnt/petrelfs/tangzecheng/MyRLHF/reetrievalheaddetect/logs/1900.err   # 错误日志
...
python reasoning_head_detection_babilong.py --context_lengths=1900