...
#SBATCH --output=/mnt/petrelfs/tangzecheng/MyRLHF/reetrievalheaddetect/logs/0.log  # 标准输出日志
#SBATCH --error=/mnt/petrelfs/tangzecheng/MyRLHF/reetrievalheaddetect/logs/0.err   # 错误日志
...
python reasoning_head_detection_babilong.py --context_lengths=0