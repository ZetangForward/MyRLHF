...
class CUSArgs:
    def __init__(self):
        ...
        self.s_len = 4000
        self.mask_topk = 32
        self.custom_block_list = True
        self.needle_ids = [4]
        self.head_file = "/mnt/petrelfs/tangzecheng/MyRLHF/reetrievalheaddetect/head_score/5-hop/success_Meta-Llama-3.1-8B-Instruct.json"
