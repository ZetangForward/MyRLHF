from test_jbb_retain_zero_embed_score import begin_test
import argparse
...
# nohup python analysis/test2_pjlab_llama_jbb_random5x100_zero_embed_score.py > ./logs/embedding_zero.log 2>&1 &

# /mnt/petrelfs/tangzecheng/MyRLHF/reetrievalheaddetect

# /mnt/petrelfs/tangzecheng/repos/Long-form-reasoning/preliminary/babilong_random5x100/results/information_flow_normal_max12k_sample3x100_gws_control_new/Meta-Llama-3.1-8B-Instruct_factor0.01/11900/label
...
if __name__ == "__main__":
    ...
    args.dataset_path = "/mnt/petrelfs/tangzecheng/local_data/pg19"
    ...
    args.save_dir ="/mnt/petrelfs/tangzecheng/repos/Long-form-reasoning/preliminary/babilong_random5x100/results/information_flow_normal_max12k_sample3x100_gws_control_new"
    import shutil
    if os.path.exists(args.save_dir + "/Meta-Llama-3.1-8B-Instruct_factor0.01/11900/label/"):
        shutil.rmtree(args.save_dir + "/Meta-Llama-3.1-8B-Instruct_factor0.01/11900/label/")
