...
# nohup python test2_pjlab_llama_jbb_random5x100.py > jbb.log 2>&1 &
if __name__ == "__main__":
    ...
    args.save_dir = "/data/zecheng/acl2025/MyRLHF/reetrievalheaddetect/analysis/information_flow_normal_max12k_sample200"
