...
DEFAULT_PROMPTS = {
    'qa2': {
        'instruction':
            ...
            'the item remains in the first location.Please only respond with \'yes\' or \'no\' and do not provide any additional information.',
        'examples':
            '<example>\n'
