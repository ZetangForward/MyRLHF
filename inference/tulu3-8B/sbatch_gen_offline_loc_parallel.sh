...
#SBATCH --job-name=Tulu-3-8B-tool-loc-parallel
#SBATCH --nodes=1                         
...
bash gen_offline.sh rapid_parallel_api tool_location allenai/Llama-3.1-Tulu-3-8B-DPO /mnt/hwfile/opendatalab/tangzecheng/benchmark_data /mnt/petrelfs/tangzecheng/local_data/inference_results/tulu-3_1-8B-dpo api 8 1