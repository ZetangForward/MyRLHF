...
#SBATCH --job-name=llama3.1-8B-Instruct-tool-location-single
#SBATCH --nodes=1                         
...
bash llama3-1-8B/gen_offline.sh rapid_single_api tool_location meta-llama/Meta-Llama-3.1-8B-Instruct /mnt/hwfile/opendatalab/tangzecheng/benchmark_data /mnt/petrelfs/tangzecheng/local_data/inference_results/llama-3_1-8B-Instruct api