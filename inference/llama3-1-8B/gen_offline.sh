...
# bash llama3-1-8B/gen_offline.sh rapid_multiple_api tool_location meta-llama/Meta-Llama-3.1-8B-Instruct /mnt/hwfile/opendatalab/tangzecheng/benchmark_data /mnt/petrelfs/tangzecheng/local_data/inference_results/llama-3_1-8B-Instruct api 2
...
# bash llama3-1-8B/gen_offline.sh rapid_multiple_api tool_calling meta-llama/Meta-Llama-3.1-8B-Instruct /mnt/petrelfs/tangzecheng/local_data/first_retrieval_res/llama-3_1-8B-Instruct /mnt/petrelfs/tangzecheng/local_data/inference_results/llama-3_1-8B-Instruct api 2
