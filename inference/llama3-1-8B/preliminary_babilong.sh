...
# bash preliminary_babilong.sh pred.jsonl reasoning /data/zecheng/hf_models/Meta-Llama-3.1-8B-Instruct /data/zecheng/Long-form-reasoning-data/data/generated_tasks /data/zecheng/acl2025/MyRLHF/evaluation/babilong/llama-3_1-8B-Instruct babilong 6 1
