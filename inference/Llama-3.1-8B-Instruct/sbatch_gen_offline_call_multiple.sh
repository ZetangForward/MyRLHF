...
#SBATCH --job-name=llama3.1-8B-Instruct-tool-call-multiple
#SBATCH --nodes=1                         
...
bash gen_offline.sh rapid_multiple_api tool_calling meta-llama/Meta-Llama-3.1-8B-Instruct /mnt/petrelfs/tangzecheng/local_data/first_retrieval_res/llama-3_1-8B-Instruct /mnt/petrelfs/tangzecheng/local_data/inference_results/llama-3_1-8B-Instruct/retrieval_then_gen api 8 2