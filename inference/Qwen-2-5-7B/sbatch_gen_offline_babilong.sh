...
bash llama3-1-8B/gen_offline.sh babilong reasoning Qwen/Qwen2.5-7B-Instruct "RMT-team/babilong" /mnt/petrelfs/tangzecheng/local_data/inference_results/Qwen-2-5-7b-instruct babilong 8