...
#SBATCH --job-name=Qwen-2-5-7B-tool-call-parallel
#SBATCH --nodes=1                         
...
bash gen_offline.sh rapid_parallel_api tool_calling Qwen/Qwen2.5-7B-Instruct /mnt/petrelfs/tangzecheng/local_data/first_retrieval_res/Qwen-2-5-7b-instruct /mnt/petrelfs/tangzecheng/local_data/inference_results/Qwen-2-5-7b-instruct/retrieval_then_gen api 8 2