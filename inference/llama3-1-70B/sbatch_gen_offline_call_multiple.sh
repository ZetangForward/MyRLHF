...
bash llama3-1-70B/gen_offline.sh rapid_multiple_api tool_calling meta-llama/Meta-Llama-3-70B-Instruct /mnt/hwfile/opendatalab/tangzecheng/benchmark_data /mnt/petrelfs/tangzecheng/local_data/inference_results/llama-3_1-70B-Instruct api