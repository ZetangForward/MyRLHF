...
# 运行训练脚本
python cal_model_inference.py --drop_num=1 --model_path=Qwen/Qwen2.5-7B-Instruct --out_file_path="/mnt/petrelfs/tangzecheng/local_data/processed_multi_hop/random_drop/qwen" --num_gpus=8