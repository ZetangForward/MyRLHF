...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed --include localhost:0,1,2,3,4,5,6,7 openrlhf/cli/train_sft_dev.py \
   ...
   --save_path ${SAVE_DIR}/checkpoint/model/llama3.1-8b-sft \
   --ckpt_path ${SAVE_DIR}//checkpoint/opt/llama3.1-8b-sft \
   --save_steps 50 \
   --num_process 48 \
   --logging_steps 1 \
   --eval_steps -1 \
   ...
   --use_tensorboard ${SAVE_DIR}/checkpoint/tensorboard/llama3.1-8b-sft/tensorboard \
