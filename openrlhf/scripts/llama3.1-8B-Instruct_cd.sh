...
deepspeed --include localhost:0,1,2,3,4,5,6,7 cli/train_cd.py \
   ...
   --save_path ${SAVE_DIR}/merge_v1_fix/Llama-3.1-8B-Instruct/context_denoise \
   --ckpt_path ${SAVE_DIR}/merge_v1_fix/Llama-3.1-8B-Instruct/context_denoise \
   --save_steps 50 \
   --logging_steps 1 \
   --eval_steps 50 \
   --zero_stage 2 \
   ...
   --wandb_project 'merge_v1_context_denoise' \
